...
function processData()
{
    ...
    x0 = math.complex((getElement("input0").value).replace("j","i"));
    ...
    x5 = math.complex((getElement("input5").value).replace("j","i"));
    x6 = math.complex((getElement("input6").value).replace("j","i"));
    x7 = math.complex((getElement("input7").value).replace("j","i"));

    getElement("stg_out").innerHTML = String(x0) +"<br><br>" + String(x1) +"<br><br>" + String(x2) +"<br><br>" + String(x3) +"<br><br>" + String(x4) +"<br><br>" + String(x5) +"<br><br>" + String(x6) +"<br><br>" + String(x7);
    ...
    getElement("stg0_out").innerHTML = String(i0) +"<br><br>" + String(i1) +"<br><br>" + String(i2) +"<br><br>" + String(i3) +"<br><br>" + String(i4) +"<br><br>" + String(i5) +"<br><br>" + String(i6) +"<br><br>" + String(i7);
    ...
    getElement("stg1_out").innerHTML = String(ii0) +"<br><br>" + String(ii1) +"<br><br>" + String(ii2) +"<br><br>" + String(ii3) +"<br><br>" + String(ii4) +"<br><br>" + String(ii5) +"<br><br>" + String(ii6) +"<br><br>" + String(ii7);
    ...
    getElement("stg2_out").innerHTML = String(iii0) +"<br><br>" + String(iii1) +"<br><br>" + String(iii2) +"<br><br>" + String(iii3) +"<br><br>" + String(iii4) +"<br><br>" + String(iii5) +"<br><br>" + String(iii6) +"<br><br>" + String(iii7);
    ...
    getElement("stg3_out").innerHTML = String(f0) +"<br><br>" + String(f1) +"<br><br>" + String(f2) +"<br><br>" + String(f3) +"<br><br>" + String(f4) +"<br><br>" + String(f5) +"<br><br>" + String(f6) +"<br><br>" + String(f7);
}