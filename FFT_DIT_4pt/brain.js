...
function processData()
{
    ...
    getElement("stg_out").innerHTML = String(x1) + "<br><br>" + String(x2) + "<br><br>" + String(x3) + "<br><br>" + String(x4);
    ...
    getElement("stg0_out").innerHTML = String(i1) + "<br><br>" + String(i2) + "<br><br>" + String(i3) + "<br><br>" + String(i4)
    ...
    getElement("stg1_out").innerHTML = String(ii1) + "<br><br>" + String(ii2) + "<br><br>" + String(ii3) + "<br><br>" + String(ii4)
    ...
    getElement("stg2_out").innerHTML = String(iii1) + "<br><br>" + String(iii2) + "<br><br>" + String(iii3) + "<br><br>" + String(iii4)
}